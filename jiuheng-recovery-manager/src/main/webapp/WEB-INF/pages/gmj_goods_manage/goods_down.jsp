...
<div id="goods_down_page2"> 
	...
	<form id="searchForm">
			...
			<tr style="margin: 20px 0px">
				...
				style="padding: 5px 0px; width: 100px;" onclick="gmj_goods_down.save();">
				...
				onclick="gmj_goods_down.back();"> <span
	...
	<div id="tb" style="display: none;">
		<a href="javascript:void(0);" class="easyui-linkbutton"
						data-options="iconCls:'icon-add',plain:true" onclick="gmj_goods_down.importStocks();">从文件导入</a>
		<input id="numberattr" style="width: 20px;"
			type="hidden" value="1"> <a href="javascript:void(0);"	class="easyui-linkbutton"
			data-options="iconCls:'icon-add',plain:true" onclick="gmj_goods_down.addRow();">增加</a>
		<a href="javascript:void(0);" class="easyui-linkbutton"
			data-options="iconCls:'icon-remove',plain:true" onclick="gmj_goods_down.delRow();">删除</a>
	</div>
</div>

<script type="text/javascript"	src="common/js/gmj_goods_manage/goods_down.js"></script>
