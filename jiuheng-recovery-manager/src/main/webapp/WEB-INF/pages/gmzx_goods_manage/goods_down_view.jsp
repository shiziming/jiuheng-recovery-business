...
<div id="gmzx_goods_down_view_page">
			...
			<c:if test="${status==0}">
				<c:if test="${FUNC_CHECK}">
					<a href="#" class="easyui-linkbutton"
							...
							onclick="gmzx_goods_down_view.check(true);">审批</a>
							<a href="#" class="easyui-linkbutton"
						data-options="toggle:true,group:'g2',plain:true,iconCls:'icon-cancel'"
						onclick="gmzx_goods_down_view.check(false);">不同意</a>
				</c:if>
				<c:if test="${FUNC_MAINTAIN}">
					<a href="#" class="easyui-linkbutton"
						data-options="toggle:true,group:'g2',plain:true,iconCls:'icon-edit'"
						onclick="gmzx_goods_down_view.update();">修改</a>
					<a href="#" class="easyui-linkbutton"
							data-options="toggle:true,group:'g2',plain:true,iconCls:'icon-remove'"
							onclick="gmzx_goods_down_view.del();">删除</a>
				</c:if>
			</c:if>
					<a href="#" class="easyui-linkbutton"
						data-options="toggle:true,group:'g2',plain:true,iconCls:'icon-back'"
						onclick="gmzx_goods_down_view.back();">返回</a>
		</div>
		<div class="easyui-layout">
			<table id="dg"></table>
		</div>
</div>
		<script type="text/javascript"	src="common/js/gmzx_goods_manage/goods_down_view.js"></script>
