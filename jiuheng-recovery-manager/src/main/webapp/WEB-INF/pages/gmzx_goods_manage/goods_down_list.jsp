	...
	<div id="goods_list_panel" class="easyui-panel">
			...
			<input type="hidden" name="billType" value="2">
				<table class="table table-hover table-condensed"
					...
					<tr>
						...
						<td width="5%"></td>
						<td width="15%" align="center">单据机构代码</td>
						<td width="5%"><input name="billOrgCode" id="billOrgCode"
							type="text" placeholder="请输入销售组织代码" class="span2"></td>
						<td width="10%" align="center">状态</td>
						<td width="10%"><select id="status" name="status" class="easyui-combobox" style='width: 100%;'>
		...
		<div id="tb" style="display: none;">
			...
			<a href="javascript:void(0);" class="easyui-linkbutton"
				...
				onclick="gmzx_goods_down_list.go_down();">新增下架</a>
			</c:if>
		</div>
...
<script type="text/javascript"	src="common/js/gmzx_goods_manage/goods_down_list.js"></script>
