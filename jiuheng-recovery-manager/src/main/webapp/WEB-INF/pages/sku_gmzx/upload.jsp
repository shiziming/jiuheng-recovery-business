...
<div id="machine_uploader">
	<!-- 列表-->
	<div align="left">
		<a class="easyui-linkbutton" data-options="iconCls:'icon-back'" onclick="skuGmzx.returnToListPage();">返回</a>
	</div>
		<div class="btns">
				<div id="picker">
					选择文件
...
<script type="text/javascript">
	...
	skuGmzx.uploader = WebUploader.create({
		auto : false,
		method : 'POST',
		swf : ctx + '/js/webuploader/Uploader.swf',
		server : ctx + '/skuGmzx/uploadPic',
	...
	skuGmzx.uploader.on('fileQueued', function(file) {
	...
	skuGmzx.uploader.on('uploadAccept', function(object, ret) {
	...
	skuGmzx.uploader.on('error', function(type) {
