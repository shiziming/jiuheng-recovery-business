...
<div id="machine_uploader">
	<!-- 列表-->
	<div align="left">
		<a class="easyui-linkbutton" data-options="iconCls:'icon-back'" onclick="skuInfo.returnToListPage();">返回</a>
	</div>
		<div class="btns">
				<div id="picker">
					选择文件
...
<script type="text/javascript">
	...
	skuInfo.uploader = WebUploader.create({
		auto : false,
		method : 'POST',
		swf : ctx + '/js/webuploader/Uploader.swf',
		server : ctx + '/sku/pic/saveSkuMachine',
	...
	skuInfo.uploader.on('fileQueued', function(file) {
	...
	skuInfo.uploader.on('uploadAccept', function(object, ret) {
	...
	skuInfo.uploader.on('error', function(type) {
