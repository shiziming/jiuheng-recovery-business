...
<div id="newActivityMagnifierWindow">
<input type="hidden" value="${salAgencyCode}" id="salAgencyCode">
	...
	<a href="javascript:void(0);" id="backbtn"
				...
				onclick="zeroBuyNewMagnifierManage.returnToListPage();">返 回</a>
...
<script type="text/javascript" src="common/js/zeroBuy/zeroBuy_NewMagnifier_Window.js"></script>
