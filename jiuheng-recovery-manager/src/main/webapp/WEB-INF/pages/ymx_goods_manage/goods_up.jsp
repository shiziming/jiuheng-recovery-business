...
<div id="ymx_goods_up_page">
	...
	<form id="searchForm">
		<table class="table table-hover table-condensed"
			...
			<tr style="margin: 20px 0px">
				...
				style="padding: 5px 0px; width: 100px;" onclick="ymx_goods_up.save();">
				...
				onclick="ymx_goods_up.back();"> <span
	...
	<div id="tb" style="display: none;">
		<a href="javascript:void(0);" class="easyui-linkbutton"
						data-options="iconCls:'icon-add',plain:true" onclick="ymx_goods_up.importStocks();">从文件导入</a>
		<input id="numberattr" style="width: 20px;"	type="hidden" value="1">
		<a href="javascript:void(0);"	class="easyui-linkbutton"
			data-options="iconCls:'icon-add',plain:true" onclick="ymx_goods_up.addRow();">增加</a>
		<a href="javascript:void(0);" class="easyui-linkbutton"
			data-options="iconCls:'icon-remove',plain:true" onclick="ymx_goods_up.delRow();">删除</a>
	</div>
</div>
<script type="text/javascript"	src="common/js/ymx_goods_manage/goods_up.js"></script>
