...
<!-- 商品下架单据查询列表 -->
	<div id="ymx_goods_list_panel" class="easyui-panel">
		<div id="goods_list_list_search_panel" class="easyui-panel" title="查询条件"
			...
			<form id="ymx_searchForm">
			<input name="channelCode" type="hidden" value="82"/>
			<input type="hidden" name="billType" value="2">
				<table class="table table-hover table-condensed"
					...
					<tr>
						...
						<td width="5%"></td>
						<td width="10%" align="right"><a href="#" id="ymx_goods_list_query"
		...
		<div id="ymx_tb" style="display: none;">
			<c:if test="${FUNC_MAINTAIN ==true}">
			<a href="javascript:void(0);" class="easyui-linkbutton"
				data-options="iconCls:'icon-add',plain:true"
				onclick="ymx_goods_down_list.go_down();">新增下架</a>
			</c:if>
		</div>
	...
	<!-- 商品上下架单据明细查看界面 -->
	<div class="easyui-panel" id="ymx_view_panel" style="display:block">
	
	</div>
	
		<!-- 新增，修改商品上架单据明细 -->
	<div class="easyui-panel" id="ymx_down_panel" style="display:block">
...
<script type="text/javascript"	src="common/js/ymx_goods_manage/goods_down_list.js"></script>
