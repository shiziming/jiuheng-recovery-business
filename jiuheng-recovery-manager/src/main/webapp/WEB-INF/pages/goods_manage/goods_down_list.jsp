	...
	<div id="goods_list_panel" class="easyui-panel">
			...
			<input type="hidden" name="billType" value="2">
				<table class="table table-hover table-condensed"
					...
					<tr>
						...
						<td width="5%"></td>
						<td width="15%" align="center">录入人</td>
		...
		<div id="tb" style="display: none;">
			...
			<a href="javascript:void(0);" class="easyui-linkbutton"
				...
				onclick="goods_down_list.go_down();">新增下架</a>
			</c:if>
		</div>
...
<script type="text/javascript"	src="common/js/goods_manage/goods_down_list.js"></script>
