		...
		<div align="right" class="easyui-panel" style="padding: 5px;">
			<c:if test="${status==0}">
				<c:if test="${FUNC_CHECK}">
						...
						onclick="goods_up_view.check(true);">审批</a>
						<a href="#" class="easyui-linkbutton"
