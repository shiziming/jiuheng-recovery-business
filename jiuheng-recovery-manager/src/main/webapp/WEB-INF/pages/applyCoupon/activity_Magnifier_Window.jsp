...
#activityMagnifierPage{
	padding-left: 50px;
	padding-top: 10px;
	padding-bottom: 10px;
}
</style>
<div id="activityMagnifierPage">
...
<div>
	<a href="javascript:void(0);" id="backbtn"
				...
				onclick="applyCouponMagnifierManage.returnToListPage();">返 回</a>
	<table id="applyCouponActivity"></table>
</div>


<script type="text/javascript" src="common/js/applyCoupon/activity_Magnifier_Window.js"></script>
