...
<div id="gmplusOrder_view" style="width: 100%; height: auto;">
		...
		<div id="order_panel" class="easyui-panel" title="主单信息"	style="width: 100%; background-color: #eff5ff;"
			data-options="collapsible:true">
				<table class="table table-hover table-condensed" style="width: 100%; padding: 3px 1% 3px 1%; ">
					<tr>
						<td width="30px" align="right" style="padding-left: 30px">国美+订单编号 :</td>
					...
					<tr>
						...
						<c:choose>
						   <c:when test="${branchOrder.yxsfdh>0}">
						    <td width="50px"><a href="#" onclick='gmplusOrderview.view(${branchOrder.yxsfdh},${(branchOrder.yxsfdh-branchOrder.yxsfdh%1000)/1000});'>${branchOrder.yxsfdh}</a></td>
						   </c:when>
	        ...
	        <table cellspacing="0" cellpadding="0" width="100%" style="border-bottom:1px solid #95B8E7" class="pn-ltable">
				<thead class="pn-lthead">
					<tr  bgcolor="#DCDCDC">
						...
						<td width="4%" style="background-color:#F4F4F4;font-size:12px;padding:3px;border-right:1px dotted #CCCCCC;">国美+商品识别号</td>
						<td width="4%" style="background-color:#F4F4F4;font-size:12px;padding:3px;border-right:1px dotted #CCCCCC;">国美+订单商品识别号</td>
				...
				<tbody class="pn-ltbody">
						<tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
							...
							<td style="background-color:#FFFFFF;font-size:12px;padding:3px;border-right:1px dotted #CCCCCC;">
								<c:choose>
									<c:when test="${empty goods.lybj}">无</c:when>
									<c:when test="${not empty goods.lybj}">
										<c:if test="${goods.lybj == 0}">否</c:if>
										<c:if test="${goods.lybj == 1}">是</c:if>
									</c:when>
								</c:choose>
							</td>
...
<!-- 		overflow-x : scroll; -->
		 	<div class="easyui-panel" title="订单履历" data-options="border:false,collapsible:true" style="width: 100%;min-height: 100px;background-color: #eff5ff;">
				...
				collapsible:true,url:'gmplusOrder/queryOrderStatusByXsfdh/'+${branchOrder.xsfdh},
				striped : true,
				autoRowHeight:true,
				checkOnSelect : true,
				singleSelect : true">
...
<!-- 							<th data-options="field:''">承运商信息</th> -->
		...
		<div style="width: 100%;padding: 5px 0px;background-color: #eff5ff;" align="center">
			<a href="javascript:void(0);" id="btnReturn"
				...
				onclick="gmplusOrderview.Return();"> <span
				style="font-size: 14px;">返 回</span>
			</a>
	   </div>
 </div>
</div>
<script type="text/javascript"	src="common/js/gmplusOrder/gmplusOrderView.js"></script>
