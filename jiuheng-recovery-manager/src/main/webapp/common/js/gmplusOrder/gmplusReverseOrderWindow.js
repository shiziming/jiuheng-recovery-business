...
creatReverseOrder.back=function(){
	$('#gmplusOrder_index_creatReverseOrder').window('close');
}

creatReverseOrder.creat=function(){
	$('#gmplusOrder_index_creatReverseOrder').window('close');
	var reverseReason=$('#gmplusOrder_index_creatReverseOrder #reverseReason').combobox('getValue');
	var xsfdh=$('#creatPositiveOrder_page #xsfdh' ).val();
	var xsddh=$('#creatPositiveOrder_page #xsddh' ).val();
	$.ajax({
        type:"POST", 
        url:"gmplusOrder/creatReverseOrder",
