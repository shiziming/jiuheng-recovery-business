...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * @param s
     * @return
     * @since 2014-10-24 9:58:39 by Tiany
     *
     */
    public static String unhtml(String s){
        if(s == null|| isTrimEmpty(s)) return s ;

        StringBuilder encoded = new StringBuilder(s.length());
        Pattern p = Pattern.compile(UNHTML_REGEX, Pattern.MULTILINE | Pattern.CASE_INSENSITIVE);
    ...
    public static String html(String s){
        ...
        StringBuilder encoded = new StringBuilder(s.length());
        Pattern p = Pattern.compile(HTML_REGEX, Pattern.MULTILINE | Pattern.CASE_INSENSITIVE);
    ...
    private static String encodeHtml(String s){
        if ("<".equals(s)){
            ...
            return HTML_CHAR_AND;
        }else if("\"".equals(s)){
            return HTML_CHAR_QUOT;
        }else if("'".equals(s)){
            return HTML_CHAR_SINGLE_QUOT;
        }else{
            return s;
        }
    }
    ...
    public static String replace(String str,String oldValue,String newValue)
    {
    	...
    	{
    		str=str.trim().replace(oldValue, newValue);
    		return str;
