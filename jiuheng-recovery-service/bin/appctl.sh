...
jar_home=.
main=com.jiuheng.service.ServiceApp
module=jiuheng-recovery-service-1.0-SNAPSHOT.jar
pidfile=logs/app.pid
logfile=logs/info.`date +%F`.log
JAVA_OPTS="-server -Xms64m -Xmx128m -XX:NewSize=32m -XX:MaxNewSize=64m -Xss256k"
